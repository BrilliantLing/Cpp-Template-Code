...
class Tuple<P1, P2, NullT, NullT, NullT>
	:public Duo<P1, P2>
{
public:
...
inline
Tuple<T1> MakeTuple(const T1& a1)
{
	return Tuple<T1>(a1);
}
...
inline
Tuple<T1, T2> MakeTuple(const T1& a1, const T2& a2)
{
...
inline
Tuple<T1, T2, T3> MakeTuple(const T1& a1, const T2& a2, const T3& a3)
{
...
template<typename T1,
		 ...
		 typename T4>
inline
Tuple<T1, T2, T3, T4> MakeTuple(const T1& a1, const T2& a2, 
...
template<typename T1,
		 ...
		 typename T5>
inline
Tuple<T1, T2, T3, T4, T5> MakeTuple(const T1& a1, const T2& a2,
									const T3& a3, const T4& a4,
									const T5& a5)
{
